...
const Payroll = ({ handleClickPaywall }: PayrollProps) => {
  return (
    <div className="flex h-auto w-full flex-col gap-6 overflow-hidden p-[16px_16px]">
      <div className="flex flex-col gap-2 text-center">
        <h1 className="font-inter text-[24px] font-bold capitalize text-black [leading-trim:both] [text-edge:cap]">
          See Your Cat's Results Now
        </h1>
        <p className="text-center font-inter text-[18px] font-medium leading-[1.3] text-[#404040] [leading-trim:both] [text-edge:cap]">
          Unlock results and exclusive features - for $0 right now
        </p>
      </div>
      <div className="flex w-full flex-col gap-[20px] rounded-[22px] border-2 border-[#DBCEC4] bg-[#F3EDE8] p-[0_48px_24px_48px]">
        <h3 className="w-full rounded-b-[14px] bg-[#FFA500] px-[28px] py-[8px] text-center font-inter text-sm font-semibold leading-[1.4] text-black [leading-trim:both] [text-edge:cap]">
          Why KittyCare?
        </h3>
      ...
      <div className="flex flex-col gap-[10px]">
        <button
          className="h-[50px] w-full rounded-2xl bg-blue-600 text-base text-white transition-colors duration-200 hover:bg-blue-700 active:bg-blue-800"
          onClick={handleClickPaywall}
        >
          Try For Free
        </button>
        <p className="text-center font-inter text-sm font-medium leading-[1.4] text-black [leading-trim:both] [text-edge:cap]">
